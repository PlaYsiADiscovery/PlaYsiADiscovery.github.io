Restarts are a way of making a specific type of character. There are player restarts (play as a nomad for example) and event restarts (used for in-game events).
